...
class HistoricalBacktester:
    ...
    def get_data(
        ...
        try:
           ...
           if start_date is not None:
            ...
            print(
                 f"First download failed for {symbol}: {e}"
           )
    ...
    # ==========================================
        ...
        if df is None or df.empty:
           ...
           print(
                f"Retrying {symbol} with Ticker.history()..."
             )
        ...
        try:
            ...
            print(
                f"Fallback failed for {symbol}: {e}"
            )
    ...
    df["RVOL"] >= RVOL_LIMIT
        ...
        print("Historical candles :", len(df))
        print("Trend OK           :", trend_count)
        print("DMI OK             :", dmi_count)
        print("ADX OK             :", adx_count)
        print("RVOL OK            :", rvol_count)
